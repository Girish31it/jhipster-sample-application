    ...
    describe('TestEntity Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/test-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TestEntity', () => {
                service.create(new TestEntity(null)).subscribe(received => {
            ...
            it('should update a TestEntity', () => {
                service.update(new TestEntity(123)).subscribe(received => {
